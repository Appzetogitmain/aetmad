...
export default function BottomNavigation() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-white/95 backdrop-blur-md dark:bg-[#1a1a1a]/95 border-t border-gray-100 dark:border-gray-800 shadow-[0_-8px_30px_rgba(0,0,0,0.04)]"
      >
      <div className="flex items-center justify-around h-auto px-2 sm:px-4">
        ...
        <Link
          ...
          className={`group flex flex-1 flex-col items-center gap-1.5 px-2 sm:px-3 py-2 transition-all duration-200 relative ${isBakery
              ? "text-[#0B3122] dark:text-[#0B3122]"
              : "text-gray-600 dark:text-gray-400"
            }`}
        >
          <Cake className={`h-5 w-5 ${isBakery ? "text-[#0B3122] dark:text-[#0B3122]" : "text-gray-600 dark:text-gray-400 group-hover:text-[#0B3122] dark:group-hover:text-[#0B3122]"}`} strokeWidth={1.5} />
          <span className={`text-xs sm:text-sm font-medium ${isBakery ? "text-[#0B3122] dark:text-[#0B3122] font-semibold" : "text-gray-600 dark:text-gray-400 group-hover:text-[#0B3122] dark:group-hover:text-[#0B3122]"}`}>
            Bakery
          </span>
          {isBakery && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#0B3122] dark:bg-[#0B3122] rounded-b-full" />
